## Name: Bianca Baccay
## Project Title: Video Play Tycoon

### What are you building?
- A text-based game which simulates a video rental store. Where you manage your money, inventory and talk to customers. However, if the store goes bankrupt then its game over. Endless if no time.

### Why is this a Java 2 Project?
- Recursion for stocking shelves from boxes within a list or set. Generics to allow for no errors in input for things like inventory storage, money and user input.
...
### AI Use Plan
- Use AI to assist if help needed to integrate features into the program. Basically a helper in my code.
