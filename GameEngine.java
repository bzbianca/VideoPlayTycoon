...
public class GameEngine {
    ...
    private void showInstructions() {
        ...
        System.out.println("- Money: Collect money through recommending tapes to customers.");
        System.out.println("- Reputation: Gain reputation by helping out customers and choosing the right decision in side quests.");
        System.out.println("MECHANICS");
        System.out.println("- Energy bar: Actions cost energy, think carefully on how you go through each day. Hitting 0 energy can cause the days to be skipped.");
        System.out.println("- Daily prep slots: Each day is limited to 5 tasks.");
        System.out.println("- Messiness bar: Shipments of tapes can be messy, clean up the store with energy to prevent a decrease in reputation.");
        System.out.println("- Inventory: Ensure that you have enough tapes to sell in the store.");
        System.out.println("- Customer Recommendations: Help out customers to collect money and gain reputation when recommending the genre tape they want.");
        System.out.println("- Side Quests: Small chance of random side quests to occur when opening the shop for the day.");
        System.out.println("- Black Market: Takes up the entirety of the day. Take the risk of using your energy to buy valuable tapes or sell your low-priced tapes for double its value!");
        System.out.println("=".repeat(80));
